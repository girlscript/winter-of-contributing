...
There are some rules for the number maze problem that we have to follow.
1. Numbers should be from 1-9.
2. Each row and column of 9X9 should have the number once. 
3. Each 3X3 box should have the number once.
*/
