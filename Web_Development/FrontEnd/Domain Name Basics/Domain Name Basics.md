...
Country codes like *.in, .uk,* etc are also abbreviated as top-level domain used for other purposes.
<br>
...
We often confuse ***domain names*** with universal ***resource locators or URLs and Internet Protocol or IP addresses.*** <br>
 ...
 *[Click here](https://help.apnic.net/s/article/What-is-an-IP-address#:~:text=IP%20addresses%20are%20made%20up,IPv6%20addresses%20128%20bits%20long.) for some references.*
