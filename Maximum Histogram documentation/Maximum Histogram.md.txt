...
https://miro.medium.com/max/3000/1*mIDtGGfUOkB3FTs7h74LtA.png
Input:- 7
        2 3 1 4 5 4 2
Output:-12
...
1. Insert index of each item if the value in that is greater or equal to the top of the stack.
2. If the top element of the stack is greater than or equal to the current element then pop from the stack until the top element in the stack is lesser than the new element.(Stack follows LIFO i.e.last in first out technique)
3.Left and right vector contains the index of the element which is closest smaller bar in the left and right respectively with respect to the current element.
4.Lastly, calculete the area for each index i.e [Area=(right-left+1)*height]
...
References:-
https://www.includehelp.com/icp/largest-rectangle-area-in-a-histogram.aspx
https://cppsecrets.com/users/69901151051101031049797110991049710848485764103109971051084699111109/C00-program-to-find-the-LargestRectangleinHistogram.php
