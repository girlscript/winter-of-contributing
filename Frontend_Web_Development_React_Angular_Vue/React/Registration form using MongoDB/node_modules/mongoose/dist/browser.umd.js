...
/*!
 * ignore
 */(e):{};if(null==this._doc&&(this.$__buildDoc(t,e,r,d,y,!1),z(this,e,r,d,y,!0,{isNew:this.isNew})),t&&(this.$__original_set?this.$__original_set(t,void 0,!0):this.$set(t,void 0,!0),t instanceof H&&(this.isNew=t.isNew)),n.willInit?s.prototype.once.call(this,"init",function(){z(o,e,r,d,y,!1,n.skipDefaults,o.isNew)}):z(this,e,r,d,y,!1,n.skipDefaults,this.isNew),this.$__._id=this._id,this.$locals={},this.$op=null,!c.options.strict&&t){var v=this;Object.keys(this._doc).forEach(function(t){t in c.tree||w(t,null,v)})}!
/*!
 ...
 * Module dependencies.
 */
var i="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},o=r(4),s=r(9),a=r(48),u=r(71),c=r(5),l=r(132),f=r(50),h=r(0).schemaTypeSymbol,p=r(3),d=r(2),y=r(0).validatorErrorSymbol,v=o.CastError,_=o.ValidatorError;function m(t,e,r){this[h]=!0,this.path=t,this.instance=r,this.validators=[],this.getters=this.constructor.hasOwnProperty("getters")?this.constructor.getters.slice():[],this.setters=[],e=e||{};var n=this.constructor.defaultOptions||{},o=Object.keys(n),a=!0,u=!1,c=void 0;try{for(var f,p=o[Symbol.iterator]();!(a=(f=p.next()).done);a=!0){var y=f.value;n.hasOwnProperty(y)&&!e.hasOwnProperty(y)&&(e[y]=n[y])}}catch(t){u=!0,c=t}finally{try{!a&&p.return&&p.return()}finally{if(u)throw c}}var v=this.OptionsConstructor||s;this.options=new v(e),this._index=null,this.selected,d.hasUserDefinedProperty(this.options,"immutable")&&(this.$immutable=this.options.immutable,l(this));var _=Object.keys(this.options),m=!0,g=!1,b=void 0;try{for(var w,O=_[Symbol.iterator]();!(m=(w=O.next()).done);m=!0){var S=w.value;if("cast"!==S&&(d.hasUserDefinedProperty(this.options,S)&&"function"==typeof this[S])){if("index"===S&&this._index){if(!1===e.index){var E=this._index;if("object"===(void 0===E?"undefined":i(E))&&null!=E){if(E.unique)throw new Error('Path "'+this.path+'" may not have `index` set to false and `unique` set to true');if(E.sparse)throw new Error('Path "'+this.path+'" may not have `index` set to false and `sparse` set to true')}this._index=!1}continue}var A=e[S];if("default"===S){this.default(A);continue}var $=Array.isArray(A)?A:[A];this[S].apply(this,$)}}}catch(t){g=!0,b=t}finally{try{!m&&O.return&&O.return()}finally{if(g)throw b}}Object.defineProperty(this,"$$context",{enumerable:!1,configurable:!1,writable:!0,value:null})}
/*!
 * ignore
