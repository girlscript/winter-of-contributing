...
Here the coloured ring is not visible because `useLevel` attribute is true which means is will used for scaling purposes and by default it's scale is 0.That is why it is not visible.

I will recommend you to play with all these values and see what it does.
