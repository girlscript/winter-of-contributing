...
* Now, You have to add RecyclerView dependency in your project, go to build.gradle of your app and add the following line to your dependencies:
...
* Now, Let's start to make the adapter for this RecyclerView. Create a new Kotlin file and name it Vertical_RVAdapter. <br>
...
* Last step, create an AsyncTask class, add the data, and update the adapter.
