### REVERSAL OF LINKED LIST WITHOUT USING STACK

- DESCRIPTION </br>
  This code reverses a linked list without using a stack.
  
- How does it work?</br>
  The user enters a list and the final reversed list is displayed.
