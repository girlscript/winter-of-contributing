...
## _See Also_ :
+ [Video](https://www.youtube.com/watch?v=V5-7GzOfADQ) tutorial for KMP Algorithm.
+ You can also refer [this](https://cp-algorithms.com/string/prefix-function.html) for more details.
